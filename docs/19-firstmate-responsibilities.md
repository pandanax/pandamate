...
| Land code | isolate the work; land the way your VCS does | branch → PR/MR → required CI → native auto-merge; never push the protected default branch directly | **PR only + watch CI**; captain merges, never deploys |
